...
def test_MAIN_FUNC_002():
    ...
    try:
        ...
        if m:
            ...
            obj = M_CTC_id_001(li[0],830,sid,USER_N,PSWRD)
        ...
        * @credits Created based on Software Release for GIRU_revC-- v{val[2]}
            ...
            hs = {'observer':'12356','stli':'4647dn','installer':'giru1234','installer':'admin','operator':'admin12345'}
            STARTUP.STORE_DATA('-'*100,'\n',OUTPUT_LIST=OUTPUT_LIST)
            STARTUP.STORE_DATA('\tThe O-RU NETCONF Serve  establishes TCP connection and performs a Call Home procedure towards the NETCONF Client and not establishes a SSH.\n\n',OUTPUT_LIST=OUTPUT_LIST)
            STARTUP.STORE_DATA('-'*100,'\n',OUTPUT_LIST=OUTPUT_LIST)
        ...
        STARTUP.CREATE_LOGS('M_CTC_ID_002',OUTPUT_LIST)
