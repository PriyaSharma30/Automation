...
CONF = {
  'SUPER_USER': 'root',
  'SUPER_USER_PASS' : {'garuda' : 'vvdn5gbudeveloperaccess', 'mcb1' : 'root'},
...
details = {
  ...
  'SUPER_USER_PASS' : list(CONF['SUPER_USER_PASS'].values())[1],
  'SUDO_USER' : 'operator',
  'SUDO_PASS' : 'admin123',
  'NMS_USER' : 'installer',
  ...
  'remote_path' : 'sftp://vvdn@192.168.4.15:22/home/vvdn/Downloads/gauda_image/giru_revALL_dummy_v4.7.1.zip',
